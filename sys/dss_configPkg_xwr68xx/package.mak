...
override PKGDIR = dss_configPkg_xwr68xx
...
package/%.xdc.inc package/%_dss_configPkg_xwr68xx.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package dss_configPkg_xwr68xx" (because $@ is older than $(firstword $?))" ...
...
package/cfg/dss_pe674.c package/cfg/dss_pe674.xdl: override _PROG_XSOPTS = -DMMWAVE_SDK_DEVICE=iwr68xx -DMMWAVE_SDK_DEVICE_TYPE=xwr68xx
...
.PHONY: release,dss_configPkg_xwr68xx
ifeq (,$(MK_NOGENDEPS))
-include package/rel/dss_configPkg_xwr68xx.tar.dep
endif
package/rel/dss_configPkg_xwr68xx/dss_configPkg_xwr68xx/package/package.rel.xml: package/package.bld.xml
package/rel/dss_configPkg_xwr68xx/dss_configPkg_xwr68xx/package/package.rel.xml: package/build.cfg
package/rel/dss_configPkg_xwr68xx/dss_configPkg_xwr68xx/package/package.rel.xml: package/package.xdc.inc
package/rel/dss_configPkg_xwr68xx/dss_configPkg_xwr68xx/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

dss_configPkg_xwr68xx.tar: package/rel/dss_configPkg_xwr68xx.xdc.inc package/rel/dss_configPkg_xwr68xx/dss_configPkg_xwr68xx/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/dss_configPkg_xwr68xx.xdc.inc,package/rel/dss_configPkg_xwr68xx.tar.dep)


release release,dss_configPkg_xwr68xx: all dss_configPkg_xwr68xx.tar
clean:: .clean
	-$(RM) dss_configPkg_xwr68xx.tar
	-$(RM) package/rel/dss_configPkg_xwr68xx.xdc.inc
	-$(RM) package/rel/dss_configPkg_xwr68xx.tar.dep
